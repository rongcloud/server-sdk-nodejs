...
// API 文档: http://rongcloud.github.io/server-sdk-nodejs/docs/v1/message/system.html#broadcast
var message = {
	senderId: '__system__',
	objectName: 'RC:TxtMsg',
	content: {
...
消息类型对应关系请参考: http://rongcloud.github.io/server-sdk-nodejs/docs/v1/GLOSSARY.html
*/ 
var message = {
	senderId: '__system__',
	objectName: 'RC:TxtMsg',
