...
exports.queryBlocked = function( format, callback ) {
	rongrequest.request( apis['user']['queryBlocked'], {}, format, function( err, result ) {
		return callback( err, result );
	} );
}

exports.addToBlackList = function( userId, blackUserId, format, callback ) {
...
exports.removeFromBlacklist = function( userId, blackUserId, format, callback ) {
...
exports.queryBlacklist = function( userId, format, callback ) {
