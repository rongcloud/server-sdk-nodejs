...
exports.create = promisify(function( chatRoomIDNamePairs, format, callback ) {
	var params = {};
	var chatRoomId;
...
exports.destroy = promisify(function( chatRoomIDs, format, callback ) {
...
exports.query = promisify(function( chatRoomIDs, format, callback ) {
	if( 'object' == typeof chatRoomIDs && chatRoomIDs.length ) {
		// Check the IDs.
...
exports.user = {};
exports.user.query = promisify(function( chatRoomId, format, callback ) {
  if( !util.validateId( chatRoomId ) ) {
	  return callback( { code : rcResult.INVALID_CHATROOMID, message : rcResult.INVALID_CHATROOMID_MSG }, null );
  }
...
exports.queryAll = promisify(function( format, callback ) {
